...
const navItems = [
  ...
  { href: "/terminal", label: "Agent Terminal", icon: "terminal" },
  { href: "/team", label: "Team Structure", icon: "users" },
  { href: "/taskboard", label: "Task Board", icon: "kanban" },
  { href: "/pipeline", label: "Content Pipeline", icon: "layers" },
  { href: "/office", label: "Digital Office", icon: "building" },
